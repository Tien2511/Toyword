    ...
    <div class="tm-welcome-section">
      ...
      <div class="container text-center tm-welcome-container">
        <div class="tm-welcome">
          ...
          <h1 class="text-uppercase mb-3 tm-site-name">Toy Word</h1>
    ...
    <div class="container">
      ...
      <div class="row tm-albums-container grid">
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            ...
            <figcaption>
              <h2>Sale off </h2>
              <p>Up to 40%. No sale for new product (30/11-3/12)</p>
            </figcaption>
          </figure>
        </div>
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
        ...
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            ...
            <figcaption>
              <h2>PDF user manual</h2>
              <p>Knowledge about our toy</p>
            </figcaption>
          </figure>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <h2 class="tm-tag-line-title">Toy World where children bring joy</h2>
          </div>
        </div>
      </div>
          ...
          <div class="media-boxes">
            <div class="media">
              ...
              <div class="media-body tm-bg-gray">
                <div class="tm-description-box">
                  <h5 class="tm-text-blue">Car</h5>
                  <p class="mb-0"><a href="https://plus.google.com/+tooplate" target="_parent"></a></p>
                </div>
            ...
            <div class="media">
              ...
              <div class="media-body tm-bg-pink-light">
                <div class="tm-description-box">
                  <h5 class="tm-text-pink">Jet Plane</h5>
                  <p class="mb-0"></p>
                </div>
                <div class="tm-buy-box">
            ...
            <div class="media">
              ...
              <div class="media-body tm-bg-pink-light">
                <div class="tm-description-box">
                  <h5 class="tm-text-pink">Video Game</h5>
                  <p class="mb-0"></p>
                </div>
                <div class="tm-buy-box">
                  <a href="#" class="tm-bg-pink tm-text-white tm-buy">buy</a>
            ...
            <div class="media">
              ...
              <div class="media-body tm-bg-gray">
                <div class="tm-description-box">
                  <h5 class="tm-text-blue">Gun Toy</h5>
                  <p class="mb-0"></p>
                </div>
                <div class="tm-buy-box">
                  <a href="#" class="tm-bg-blue tm-text-white tm-buy">buy</a>
      ...
      <div class="row tm-mb-big tm-subscribe-row">
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 tm-bg-gray tm-subscribe-form">
          <h3 class="tm-text-pink tm-mb-30">Toy Word</h3>
          <p class="tm-mb-30">We have our own toy manufacturing system and can tailor it to your own requirements. With more than 10 years in the industry, we are confident to satisfy you.</p>
      ...
      <div class="row tm-mb-medium">
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-4">
          <h4 class="mb-4 tm-font-300">Latest Toy</h4>
      ...
      <footer class="row">
        <div class="col-xl-12">
          <p class="text-center p-4">  --- Greenwich University 2020 --- 
          
          - Design by Thanh Tien  </p>
        </div>
      </footer>
    </div> <!-- .container -->
